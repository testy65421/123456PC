...
async def MessageBox_command(ctx: SlashContext, message: str):
    if ctx.channel.name == channel_name:
        ...
        options=[
            create_select_option(label="Error", value="Errors"),
            create_select_option(label="Warning", value="Warnings"),
            create_select_option(label="Info", value="Infos"),
            create_select_option(label="Question", value="Questions"),
        ],
